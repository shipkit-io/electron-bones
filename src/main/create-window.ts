...
export const createMainWindow = async () => {
	const options: BrowserWindowConstructorOptions = {
		...
		// On Windows, `transparent: true` strips the WS_THICKFRAME window style,
		// which disables maximize and snap gestures. Only enable on macOS where
		// vibrancy requires it.
